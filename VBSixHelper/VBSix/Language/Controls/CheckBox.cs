...
{
    /// <summary>
    /// Represents the properties specific to a VB6 CheckBox control.
    /// These properties are typically found in a .frm file.
    /// </summary>
    public class CheckBoxProperties
    {
        public JustifyAlignment Alignment { get; set; } = JustifyAlignment.LeftJustify;
        ...
        public string Caption { get; set; } = "Check1"; // Default caption can vary (e.g., "Check1")
        ...
        // Their resolved byte[] data will be stored in the VB6CheckBoxKind class.
        ...
        public Style Style { get; set; } = Controls.Style.Standard;
        public int TabIndex { get; set; } = 0; // Placeholder, actual index depends on order
        ...
        public CheckBoxValue Value { get; set; } = CheckBoxValue.Unchecked;
        ...
        /// <summary>
        /// Initializes CheckBoxProperties by parsing values from a raw property dictionary.
        /// </summary>
        /// <param name="rawProps">The dictionary of raw property names and values.</param>
        public CheckBoxProperties(IDictionary<string, PropertyValue> rawProps)
        {
            ...
            Value = rawProps.GetEnum("Value", Value);
