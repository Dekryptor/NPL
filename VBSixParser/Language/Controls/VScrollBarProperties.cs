...
namespace VB6Parse.Language.Controls
{
    public class VScrollBarProperties : ControlSpecificPropertiesBase
    {
        ...
        public int Height { get; set; } = 1215; // Default height for VScrollBar
        ...
        // RightToLeft is less directly applicable to VScrollBar in terms of its primary function
        ...
        public int Width { get; set; } = 255; // Default width for VScrollBar (fixed)

        // VScrollBars do not have Font, BackColor, ForeColor, Caption properties.
        // The base Font property will be nullified.

        public VScrollBarProperties()
        {
